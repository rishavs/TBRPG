...
// load entities data
module.exports = masterEntities = require('./logic/data/entities.json');


// create map object
module.exports = masterMapData = require('./logic/data/mapData.json');

// load map grid data


// load map objects data

// generate grid in memory
